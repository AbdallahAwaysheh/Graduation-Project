...
import { Edit, Trash2, Search, DollarSign, Users } from 'lucide-react';
            ...
            axios.get('http://127.0.0.1:8000/api/expenses')
                .then(response => {
                    ...
                    response.data.forEach((expense) => {
                        total_Expenses += JSON.parse(expense.amount);
                    });
                        ...
                        {filteredExpenses.map((expense) => (
                            ...
                            >
                                ...
                                <td className='flex px-6 py-4 whitespace-nowrap text-sm text-gray-300'>
                                    ...
                                    <button onClick={() => handleDelete(expense.id)} className='text-red-400 hover:text-red-300'>
                                        <Trash2 size={18} />
                                    </button>
                                </td>
                            </motion.tr>
